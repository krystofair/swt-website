...
Modified by krystofair for restrict use of RAM.
-----------------------------------------------
This version can run ./manage.py clearsessions with consume only 12MB of RAM.
If it loaded full apps project has, it would consume almost 120MB. So I left you
do math. :)
Additionally will create another process this use for asynchronous calculations.
So you know, this is nice optimization, for systems with small available memory.
...
INSTALLED_APPS = [
    ...
    'django.contrib.sessions',  # for clearsessions command
